...
export default function Contctinfo() {
  ...
  return (
    ...
    >
      ...
      {/* Description */}
        ...
        >
            Discover how Novrith Techno transforms ideas into powerful digital realities.  Each project reflects our passion for creativity, precision, and technology. 
      </motion.p>
    </section>
  );
}
